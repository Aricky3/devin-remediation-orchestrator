...
class Orchestrator:
    ...
    def build_prompt(self, issue: Issue) -> str:
        ...
        return (
            ...
            f"4. Open a pull request against the default branch of `{s.github_repo}` whose description "
            f"includes \"Closes #{issue.number}\" so merging the PR closes this issue.\n"
            "5. Keep the PR description high-signal: what changed and why.\n\n"
            "When you are finished, set your structured output with status=completed and the pr_url. "
